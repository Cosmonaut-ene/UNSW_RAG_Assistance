...
| A3 | HyDE prompt 去掉编造课程代码的指令 | `fix/hyde-prompt-fabrication` | 已完成 | [#9](https://github.com/Cosmonaut-ene/UNSW_RAG_Assistance/pull/9) |
...
| C2 | 生成 prompt 加分隔符 + 间接注入防线 | `feat/generation-injection-defense` | 已完成 | [#13](https://github.com/Cosmonaut-ene/UNSW_RAG_Assistance/pull/13) | 建议与 C1 同一 PR |
| C3 | 合并 `query_rewrite` 与 `hyde_generate` 为单次结构化调用 | `refactor/merge-query-rewrite-hyde` | 已完成 | [#14](https://github.com/Cosmonaut-ene/UNSW_RAG_Assistance/pull/14) | 依赖 C1 |

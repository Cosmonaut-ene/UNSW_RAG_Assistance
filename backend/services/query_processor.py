...
def process_with_ai(question):
    ...
    try:
        ...
        rag_answer = process_with_rag(question)
...
def save_to_admin_system(question, answer, answered, session_id):
    """
    ...
    print(f"[QueryProcessor] Saved to chat log. answered={answered}, message_id={message_id}")
